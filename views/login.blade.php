...
<html lang="en">
  <head>
    ...
    <!-- Font Awesome -->
    <link href="{{ url () }}/resources/css/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <!-- NProgress -->
    <link href="{{ url () }}/resources/css/nprogress.css" rel="stylesheet">
    <!-- Animate.css -->
    <link href="{{ url () }}/resources/css/animate.min.css" rel="stylesheet">
    <!-- Custom Theme Style -->
    <link href="{{ url () }}/resources/css/custom.css" rel="stylesheet">
    <!-- Mi Estilo -->
    <link rel="stylesheet" type="text/css" href="{{ url () }}/resources/css/my_style_login.css">
  </head>
    ...
    <div>
      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <div class="logo"> <img src="{{ url () }}/resources/images/logo_sena.png"></div>
